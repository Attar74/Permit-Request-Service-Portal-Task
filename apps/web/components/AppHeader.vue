    ...
    >
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          ...
          class="md:hidden h-10 w-10 rounded-lg border bg-card hover:bg-accent hover:text-accent-foreground flex items-center justify-center transition-all hover:scale-105 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 shadow-sm"
          type="button"
        ...
        <div class="relative">
          ...
          >
            <div
              ...
              ref="languageMenuRef"
              class="absolute right-0 mt-2 w-56 rounded-lg border bg-popover shadow-xl z-50 overflow-hidden backdrop-blur-sm"
            >
              <div class="py-1.5">
                <button
                  @click="setLocale('en')"
