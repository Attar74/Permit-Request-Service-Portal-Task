<template>
  <div class="space-y-6">
    <!-- Header Section -->
    <div
      class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-2 border-b border-gray-200"
    >
      <div class="space-y-1">
    ...
    <div
      v-if="props.pending"
      class="rounded-[1rem] border border-gray-200 bg-white text-gray-900 shadow-md py-16"
    >
      <div class="text-center text-gray-600">
        <div class="mb-4 flex justify-center">
          <Icon
            name="lucide:loader-2"
            class="h-12 w-12 animate-spin text-teal-700"
          />
        </div>
    ...
    <div
      ...
      class="rounded-[1rem] border border-red-200 bg-red-50 text-gray-900 shadow-md py-16"
    >
    ...
    >
      <div class="text-center text-gray-600">
        ...
        <NuxtLink
          to="/apply"
          class="inline-flex items-center gap-2 px-6 py-3 bg-teal-700 text-white font-semibold rounded-lg hover:bg-teal-800 transition-colors shadow-md hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
        >
    ...
    <div
      ...
      class="rounded-[1rem] border border-gray-200 bg-white text-gray-900 shadow-md overflow-hidden"
    >
              ...
              >
                ...
                <td class="p-6 align-middle">
                  <a
                    ...
                    class="text-sm text-teal-700 hover:underline font-medium transition-colors"
                  >
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div
        ...
        :key="application.id"
        class="group rounded-[1rem] border border-gray-200 bg-white text-gray-900 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden"
      >
        <!-- Card Header -->
        <div class="flex flex-col space-y-3 p-6 pb-4 border-b border-gray-200">
          <div class="flex items-start justify-between gap-3">
            <div class="flex-1 min-w-0">
              <h3
                class="text-lg font-bold leading-tight tracking-tight text-gray-900 mb-1.5"
              >
                Application #{{ String(application.id).substring(0, 8) }}
              </h3>
              <p
                class="text-xs text-gray-600 font-medium flex items-center gap-1.5"
              >
        ...
        <div class="p-6 pt-5 space-y-5">
          <div class="space-y-1.5">
            <p
              class="text-xs font-bold text-gray-600 uppercase tracking-wider flex items-center gap-1.5"
            >
          ...
          <div class="space-y-1.5">
            ...
            <a
              :href="`mailto:${application.applicantEmail}`"
              class="text-sm text-teal-700 hover:underline font-medium transition-colors break-all block"
            >
              {{ application.applicantEmail }}
            </a>
          </div>
